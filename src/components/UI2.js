                                        ...
                                        <Media.Body className="border-bottom pb-2">
                                            <table>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" className="form-control-sm border-bottom" style={{border: 'none'}} id="set1" name="set1" /></td>
                                                </tr>
                                            </table>
                                        </Media.Body>
                                    </Media>
                                    <Media className="mb-2">
                                        ...
                                        <Media.Body className="border-bottom pb-2">
                                            <table>
                                                ...
                                                <tr>
                                                    <th className="pr-3">Key</th>
                                                    <td><input type="text" className="form-control-sm border-bottom" style={{border: 'none'}} id="set2" name="set2" /></td>
                                                </tr>
                                            </table>
                                        </Media.Body>
                                    </Media>
                                    <Media className="mb-2">
                                        ...
                                        <Media.Body className="border-bottom pb-2">
                                            <table>
                                                ...
                                                <tr>
                                                    <th className="pr-3">Key</th>
                                                    <td><input type="text" className="form-control-sm border-bottom" style={{border: 'none'}} id="set3" name="set3" /></td>
                                                </tr>
                                            </table>
                                        </Media.Body>
                                    </Media>
                                    <Media className="mb-2">
                                        ...
                                        <Media.Body className="border-bottom pb-2">
                                            <table>
                                                ...
                                                <tr>
                                                    <th className="pr-3">Key</th>
                                                    <td><input type="text" className="form-control-sm border-bottom" style={{border: 'none'}} id="set4" name="set4" /></td>
                                                </tr>
                                            </table>
                                        </Media.Body>
                                    </Media>
